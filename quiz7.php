...
<body style="background-image: url('images/lessonsbg.png');">
    ...
    <div class="quiz_box">
        <header>
            <div class="title">Nitrogen Quiz</div>
            <div class="timer">
    ...
    let questions = [
        {
            numb: 1,
            question: "What is the atomic number and symbol of nitrogen in the periodic table?",
            answer: "Atomic number 7, symbol N",
            options: [
        ...
        {
            numb: 2,
            question: "What is the primary state of nitrogen at room temperature, and what is its density compared to air?",
            answer: "Gas; lighter than air",
            options: [
                "Gas; heavier than air",
                "Solid; lighter than air",
                "Liquid; similar density to air",
                "Gas; lighter than air"
            ]
        },
        {
            numb: 3,
            question: "How does nitrogen enter the biological cycle, and what process is responsible for this?",
            answer: "Through photosynthesis; nitrogen fixation",
            options: [
                "Through photosynthesis; nitrogen fixation",
                "Through respiration; combustion",
                "Through transpiration; evaporation",
                "Through digestion; fermentation"
            ]
        },
        {
            numb: 4,
            question: "In the Haber-Bosch process, what is produced when nitrogen gas reacts with hydrogen gas under specific conditions and with a catalyst?",
            answer: "Ammonia (NH3)",
            options: [
                "Oxygen gas (O2)",
                "Ammonia (NH3)",
        ...
        {
            numb: 5,
            question: "What role does nitrogen play in the preservation of historic documents and artifacts, and why is it used for this purpose?",
            answer: "It prevents degradation due to exposure to oxygen.",
            options: [
                "It enhances the visual appearance of artifacts.",
                "It prevents degradation due to exposure to oxygen.",
                "It adds color and scent to the preserved items.",
                "It accelerates the degradation process."
            ]
        },
    ];
</script>
    ...
    document.querySelector('.result_box .buttons .quit').addEventListener('click', function() {
        ...
        window.location.href = "element8.php"; // Example: Navigate to the next lesson
    });
